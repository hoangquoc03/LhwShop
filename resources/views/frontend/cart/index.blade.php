...
<div class="container py-5">
        ...
        <div class="col-lg-8">
            <div class="card shadow-sm mb-3 border-0 rounded-3 animate__animated animate__fadeInLeft">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center mb-4 cart-item p-3 rounded hover-scale" data-id="{{ $id }}">
                        <img src="{{ $item['image'] }}" class="rounded shadow-sm me-3 cart-img"
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="input-group input-group-sm me-3" style="width: 120px;">
                                        <button type="button" class="btn btn-outline-secondary btn-qty" data-type="minus" data-id="{{ $id }}">−</button>
                                        <input type="text" class="form-control text-center qty-input" value="{{ $item['quantity'] }}" data-id="{{ $id }}" readonly>
        ...
        <div class="col-lg-4">
            <div class="card shadow-sm p-4 border-0 rounded-3 animate__animated animate__fadeInRight">
                ...
                <div class="d-flex justify-content-between mb-3">
                    <span>Tổng tiền:</span>
                    <span class="text-primary fw-bold fs-5">{{ number_format($total,0,',','.') }}₫</span>
                </div>
                ...
                @else
                    ...
                    <a href="{{ route('frontend.login.index') }}" class="btn btn-primary btn-lg w-100 mb-3 rounded-pill shadow-sm animate-btn">
                        <i class="ti-lock"></i> Đăng nhập để thanh toán
                    </a>
                @endif

                <a href="{{ route('frontend.home.index') }}" class="btn btn-outline-secondary btn-lg w-100 rounded-pill shadow-sm animate-btn">
    ...
    <div class="text-center py-5 animate__animated animate__fadeIn">
        ...
        <a href="{{ route('frontend.home.index') }}" class="btn btn-primary mt-3 px-4 py-2 rounded-pill shadow-sm animate-btn">
            <i class="ti-arrow-left"></i> Tiếp tục mua sắm
        </a>
    </div>
    @endif
