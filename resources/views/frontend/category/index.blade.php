...
<div class="container my-5">
  ...
  <div class="d-flex flex-wrap justify-content-center align-items-center gap-4 supplier-logos">
...
<div class="container my-4">
  ...
  <div class="row g-4" id="product-list">
    @include('frontend.category.partials.products', ['products' => $products])
  </div>
