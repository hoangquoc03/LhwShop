                ...
                <div class="col-lg-6">
                    <div class="login_box_img">
                        <div class="hover">
                            ...
                            <p>Hãy đăng ký tài khoản để trải nghiệm các tính năng tuyệt vời và cập nhật thông tin mới nhất.
                            </p>
                ...
                <div class="col-lg-6">
                    <div class="login_form_inner">
                        ...
                        <div class="social-login">
                            <a href="{{ route('login.facebook') }}" class="btn btn-primary w-100 mb-2">
                                <i class="ti-facebook"></i> Đăng nhập bằng Facebook
                            </a>
                        </div>

                        <form class="row login_form" action="{{ route('frontend.login.post') }}" method="POST"
                            id="loginForm">
                            @csrf
                            <!-- Username -->
