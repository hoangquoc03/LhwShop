                ...
                <div class="overflow-hidden shadow" bis_skin_checked="1">
                    <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                                ...
                                <tr data-search="{{ Str::lower($product->product_name) }}"
                                   ...
                                   w-5 h-5 text-xs text-white bg-red-600 rounded-full btn-delete"
                                    ...
                                    <td class="p-4 whitespace-nowrap">
                                        <button data-drawer-target="drawer-update-product-{{ $productId }}"
                                            data-drawer-show="drawer-update-product-{{ $productId }}"
                        ...
                        @foreach ($groupedProductImages as $productId => $images)
                            ...
                            <div id="drawer-update-product-{{ $productId }}"
                                class="fixed top-0 right-0 z-40 w-full h-screen max-w-md p-4
                overflow-y-auto transition-transform translate-x-full
                bg-white dark:bg-gray-800"
                                tabindex="-1">

                                <h5 class="mb-4 text-sm font-semibold text-gray-500 uppercase">
                                    Cập nhật hình ảnh – {{ $product->product_name }}
                                </h5>

                                <button type="button" data-drawer-dismiss="drawer-update-product-{{ $productId }}"
                                    ...
                                    @foreach ($images as $item)
                                        <div class="flex items-center gap-3">
                                            ...
                                            <form action="{{ route('backend.ProductImg.update', $item->id) }}"
                                                ...
                                                <button type="submit"
                                                    class="px-3 py-1 text-sm text-white bg-primary-600 rounded">
                                                    Cập nhật ảnh
                                                </button>
                                            </form>
                                        </div>
