                ...
                >
                    ...
                    >
                        ...
                        >
                            <ul class="pb-2 space-y-2">
                                ...
                                <li>
                                    <button
                                        ...
                                        aria-controls="dropdown-vaitro"
                                        data-collapse-toggle="dropdown-vaitro"
                                        aria-expanded="false"
                                    >
                                        <svg
                                    ...
                                    <ul
                                        id="dropdown-vaitro"
                                        class="py-2 space-y-2 block hidden"
                                    >
                                        <li>
                                            <a
                                                href="/backend/AclUser"
                                        ...
                                        <li>
                                            <a
                                                href="/api/acl_role_has_permissions"
                                                class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                                                > Nhân viên có quyền cho phép</a
                                            >
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li>
                                    ...
                                    >
                                        ...
                                        <li>
                                            <a
                                                href="/backend/ShopProductReview"
                                                class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                                                >Đánh giá sản phẩm</a
                                            >
                                        </li>
                                ...
                                <li>
                                    <button
                                        type="button"
                                        class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                                        aria-controls="dropdown-khohang"
                                        data-collapse-toggle="dropdown-khohang"
                                        aria-expanded="false"
                                    >
                                        <svg
                                            class="w-6 h-6 text-gray-500 dark:text-white"
                                ...
                                <li>
                                    <button
                                        type="button"
                                        class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                                        aria-controls="dropdown-giamgia"
                                        data-collapse-toggle="dropdown-giamgia"
                                        aria-expanded="false"
                                    >
                                        <svg
                                            class="w-6 h-6 text-gray-500 dark:text-white"
                                    ...
                                    >
                                        ...
                                        <li>
                                            <a
                                                href="/backend/ShopProductVoucher"
                                                class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                                                >Sản phẩm giảm giá</a
                                            >
                                        </li>
                                        <li>
                                            <a
                                                href="/backend/ShopCustomerVoucher"
                                                class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                                                >Khách hàng nhận giảm giá</a
                                            >
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    <button
                                        ...
                                        data-collapse-toggle="dropdown-order"
                                        aria-expanded="false"
                                    >
                                        <svg
                                            class="w-6 h-6 text-gray-500 dark:text-white"
                            ...
                            <div class="pt-2 space-y-2" bis_skin_checked="1">
