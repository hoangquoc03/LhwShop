<nav
        ...
        >
            <div class="px-3 py-3 lg:px-5 lg:pl-3" bis_skin_checked="1">
                <div
                ...
                >
                    ...
                    <div class="flex items-center" bis_skin_checked="1">
                        <div
                            class="hidden mr-3 -mb-1 sm:block"
                            bis_skin_checked="1"
                        >
                            <span></span>
                        </div>
                        ...
                        <div
                            ...
                            style="
                                ...
                                margin: 0px;
                                transform: translate(287px, 62px);
                            "
                        >
                            <div
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <span
                                                ...
                                                >Bonnie Green</span
                                            >:Chào, có chuyện gì vậy? Bạn đã sẵn sàng cho bài thuyết trình chưa?
                                        </div>
                                        <div
                        ...
                        <div
                            ...
                            style="
                                ...
                                inset: 0px auto auto 0px;
                                margin: 0px;
                                transform: translate(1773px, 165px);
                            "
                            aria-hidden="true"
                            data-popper-placement="bottom"
                        >
                        ...
                        <div
                            ...
                            style="
                                ...
                                inset: 0px auto auto 0px;
                                margin: 0px;
                                transform: translate(1741px, 63px);
                            "
                            data-popper-placement="bottom"
                        >
                            Bật chế độ tối
                        ...
                        >
                            ...
                            <div
                                ...
                                style="
                                    ...
                                    inset: 0px auto auto 0px;
                                    margin: 0px;
                                    transform: translate(375px, 58px);
                                "
                            >
                                <div
                                    class="px-4 py-3"
                                ...
                                <ul class="py-1" role="none">
                                    ...
                                    <li>
                                    <!-- Form ẩn dùng để logout -->
                                    <form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
                                        @csrf
                                    </form>

                                    <!-- Link "Đăng xuất" gọi form bằng JS -->
                                    <a
                                        href="#"
