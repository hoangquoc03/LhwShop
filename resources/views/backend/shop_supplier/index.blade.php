...
@section('main-content')
                    ...
                    <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                                ...
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="p-4">
                                        <img src="{{ Str::startsWith($item->image, ['http://', 'https://'])
                                            ? $item->image
                                            : asset('storage/uploads/suppliers/logo/' . $item->image) }}"
                                    ...
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $item->updated_at == null ? '' : $item->updated_at->diffForHumans() }}
                                    </td>
                                    <td class="p-4 space-x-2 whitespace-nowrap">
                                        <button type="button" id="updateProductButton"
                                            ...
                                            data-description="{{ $item->description }}" {{-- data-url="{{ route('backend.shop_setting.update', $item->id) }}" --}}>
                        ...
                        @foreach ($dsShopSuppliers as $item)
                            <div id="drawer-update-product-{{ $item->id }}"
                                ...
                                <form action="{{ route('backend.Supplier.update', ['id' => $item->id]) }}" method="POST"
                                    ...
                                    <div class="space-y-4" bis_skin_checked="1">
                                        <div bis_skin_checked="1">
                                            <label for="supplier_code"
                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Mã nhà
                                                danh mục 2</label>
                                            <input value="{{ $item->supplier_code }}" type="text"
                                                name="supplier_code" id="supplier_code"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                placeholder="supplier_code" required="">
                                        </div>

                                        <div bis_skin_checked="1">
                                            <label for="supplier_text"
                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Văn
                                                bản Nhà danh mục 2</label>
                                            <input value="{{ $item->supplier_text }}" type="text"
                                                name="supplier_text" id="supplier_text"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                placeholder="supplier_text" required="">
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <img src="{{ asset('storage/uploads/suppliers/logo/' . $item->image) }}"
                                    ...
                                    <div class="bottom-0 left-0 flex justify-center w-full pb-4 mt-4 space-x-4 sm:absolute sm:px-4 sm:mt-0"
                                        bis_skin_checked="1">
                                        <button data-url="{{ route('backend.Supplier.index') }}" type="submit"
                                        ...
                                        <button data-url="{{ route('backend.Supplier.index') }}" type="button"
    ...
    <div id="drawer-create-product-default"
        ...
        <form id ="frmCreate" action="{{ route('backend.Supplier.store') }}" method="POST"
            enctype="multipart/form-data">
            @csrf
            <div class="space-y-4" bis_skin_checked="1">
                <div class="space-y-4" bis_skin_checked="1">
                    <div bis_skin_checked="1">
                        <label for="supplier_code" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Mã
                            nhà danh mục 2</label>
                        <input value="{{ old('supplier_code') }}" type="text" name="supplier_code"
                            id="supplier_code"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            placeholder="supplier_code" required="">
                    </div>
                    ...
                    <div bis_skin_checked="1">
                        <label for="supplier_text"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Văn bản nhà danh mục
                            2</label>
                        <input value="{{ old('supplier_text') }}" type="text" name="supplier_text"
                            id="supplier_text"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            placeholder="supplier_text" required="">
                    </div>
