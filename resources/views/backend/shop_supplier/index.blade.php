                ...
                <div class="overflow-hidden shadow" bis_skin_checked="1">
                    <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                        ...
                        <div id="drawer-update-product-{{ $item->id }}" class="fixed top-0 right-0 z-40 w-full h-screen max-w-xs p-4 overflow-y-auto transition-transform bg-white dark:bg-gray-800 translate-x-full" tabindex="-1" aria-labelledby="drawer-label-{{ $item->id }}" bis_skin_checked="1" aria-hidden="true">
                                ...
                                Cập nhật Nhà cung cấp- {{ $item->id }}</h5>
                            ...
                            <form action="{{ route('backend.Supplier.update',['id' => $item->id]) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="space-y-4" bis_skin_checked="1">
                                    <div bis_skin_checked="1">
                                        <label for="supplier_code" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Mã nhà cung cấp</label>
                                    ...
                                    <div bis_skin_checked="1">
                                        <label for="supplier_text" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Văn bản Nhà cung cấp</label>
    ...
    $('#frmCreate').validate({
        ...
        messages: {
            supplier_code: {
                ...
                minlength: 'Mã nhà cung cấp phải từ 3 ký tự trở lên.',
                maxlength: 'Mã nhà cung cấp phải dưới 100 ký tự.'
            },
            supplier_text: {
                required: 'Vui lòng nhập văn bản nhà cung cấp.',
                minlength: 'Văn bản nhà cung cấp phải từ 3 ký tự trở lên.',
                maxlength: 'Văn bản nhà cung cấp phải dưới 100 ký tự.'
            },
            image: {
