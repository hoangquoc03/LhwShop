...
<main class="bg-gray-50 dark:bg-gray-900">
    ...
    <div class="flex flex-col justify-center items-center px-6 mx-auto h-screen xl:px-0 dark:bg-gray-900" bis_skin_checked="1">
        ...
        <div class="text-center xl:max-w-4xl" bis_skin_checked="1">
            <h1 class="mb-3 text-2xl font-bold leading-tight text-gray-900 sm:text-4xl lg:text-5xl dark:text-white">Có điều gì đó đã sai nghiêm trọng</h1>
            <p class="mb-5 text-base font-normal text-gray-500 md:text-lg dark:text-gray-400">Bạn không có quyền truy cập.</p>
